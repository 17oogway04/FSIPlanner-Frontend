...
const routes: Routes = [
  ...
  {
    path: 'client-edit-user/:username',
  ...
  {
    path: 'edit-disability/:id',
    loadChildren: () => import('./Components/User/edit-disability/edit-disability.module').then( m => m.EditDisabilityPageModule)
  },
  {
  ...
  {
    path: 'client-edit-disability/:id',
    loadChildren: () => import('./Components/fsi-clients/client-edit-disability/client-edit-disability.module').then( m => m.ClientEditDisabilityPageModule)
  },
