...
@Component({
  ...
  templateUrl: './asset-overview.page.html',
  styleUrls: ['./asset-overview.page.scss'],
  template: '<canvas id="pie-chart" width="400" height="400"></canvas>'
})
export class AssetOverviewPage implements OnInit {
