...
@Component({
  ...
  templateUrl: './client-edit-disability.page.html',
  styleUrls: ['./client-edit-disability.page.scss'],
})
export class ClientEditDisabilityPage implements OnInit {
  id: string = "0";
  ...
  onSubmit(){
    this.myDisabilityService.updateDisability(parseInt(this.id), this.currentDisability).subscribe(() => {
      ...
      this.router.navigate(['client-disability/'])
